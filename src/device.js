...
Device.prototype.userAgent = function(version) {
    return _.template(CONSTANTS.chromeAgentTemplate)({
...
Device.prototype.userAgentDesktop = function(version) {
    return CONSTANTS.chromeAgentDesktopTemplate;
}